...
function Main() {
  return (
    <main className="shadow-profile-card-primary-dark-blue-200/40 z-20 mt-[1px] flex h-[374px] w-[calc(100vw-50px)] max-w-[325px] flex-col items-center overflow-hidden rounded-[14px] bg-white shadow-2xl">
      <header className="relative aspect-[325/140] w-full">
        <Image
      ...
      <div className="border-t-profile-card-neutral/20 mt-auto grid h-[89px] w-full grid-cols-3 grid-rows-1 items-center gap-[14px] border-t pb-[2px]">
        <p className="text-profile-card-primary-dark-blue-200 flex flex-col items-center justify-self-end text-[18px] font-bold tracking-[0.5px]">
          80K
          <span className="text-profile-card-primary-dark-blue-100 mt-[1px] text-[10px] font-normal tracking-[1.3px]"> Followers</span>
        </p>
        <p className="text-profile-card-primary-dark-blue-200 flex flex-col items-center text-[18px] font-bold tracking-[0.5px]">
          803K
          <span className="text-profile-card-primary-dark-blue-100 mt-[1px] text-[10px] font-normal tracking-[1.3px]"> Likes</span>
        </p>
        <p className="text-profile-card-primary-dark-blue-200 ml-[6px] flex flex-col items-center justify-self-start text-[18px] font-bold tracking-[0.5px]">
          1.4K
          <span className="text-profile-card-primary-dark-blue-100 mt-[1px] text-[10px] font-normal tracking-[1.3px]"> Photos</span>
        </p>
      </div>
    </main>
  );
