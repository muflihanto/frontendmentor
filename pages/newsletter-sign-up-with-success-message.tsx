...
function Main() {
  ...
  return (
    <div className="w-full px-6 pb-10 pt-[30px]">
      <h1 className="text-newsletter-neutral-400 text-[40px] font-bold">Stay updated!</h1>
      <p className="text-newsletter-neutral-300 mt-[13px]">Join 60,000+ product managers receiving monthly updates on:</p>
      <ul className="text-newsletter-neutral-300 mt-[26px] flex flex-col gap-3">
        <li className="flex items-start gap-4">
          <IconList className="w-[23px]" />
          <p className="-mt-[2px]">Product discovery and building what matters</p>
        </li>
        <li className="flex items-start gap-4">
          <IconList className="w-[22px]" />
...
function IllustrationSignUp() {
  return (
    <>
      <svg
        className="h-[284px] w-[375px] lg:hidden"
        xmlns="http://www.w3.org/2000/svg"
      ...
      <svg
        className="h-[593px] w-[400px] max-lg:hidden"
        xmlns="http://www.w3.org/2000/svg"
        xmlnsXlink="http://www.w3.org/1999/xlink"
        viewBox="0 0 400 593"
      >
