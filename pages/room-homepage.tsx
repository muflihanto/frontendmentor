...
function Header() {
  ...
  return (
    <>
      <motion.header
        className={`absolute left-0 top-0 z-20 flex h-[110px] w-full items-center px-6`}
      ...
      >
        ...
        <AnimatePresence>
          {menuOpen ? (
            <nav className="ml-auto pt-[3px]">
              <ul className="flex gap-8">
                <li>
                  <a
                    className="text-room-primary-300 text-[17px] font-bold lowercase leading-none tracking-[-1.25px]"
                    href=""
                  >
                    Home
                  </a>
            ...
            <svg
              viewBox="0 0 62 14"
              className="absolute left-1/2 top-1/2 h-[14px] -translate-x-1/2 -translate-y-1/2"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
    ...
    >
      ...
      <div className="h-[410px] w-full px-8 py-[61px]">
        ...
        <a
          ...
          className="mt-10 flex items-center gap-[18px] text-[15px] uppercase leading-none tracking-[12.5px]"
        >
          Shop Now
          <svg
            className="w-10"
