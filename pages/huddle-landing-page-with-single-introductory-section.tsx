    ...
    <div className="w-[calc(100vw-72px)] max-w-[calc(375px-72px)] lg:w-[calc(100vw-160px)] lg:max-w-[calc(1440px-160px)]">
      ...
      <div className="flex flex-col items-center lg:mt-[92px] lg:grid lg:grid-cols-[calc(696/1440*100vw),auto] lg:grid-rows-1">
        ...
        <main className="lg:ml-[min(calc(58/1440*100vw),58px)] lg:self-start lg:pr-1 lg:pt-[39px]">
          ...
          <a
            href=""
            className="text-huddle-intro-primary-violet font-poppins mx-auto mt-6 flex h-[40px] w-[200px] items-center justify-center rounded-full bg-white pt-[2.2px] text-[12px] shadow-xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white lg:ml-0 lg:h-[56px] lg:pt-0 lg:text-[18px]"
          >
            Register
          </a>
        </main>
...
function Footer() {
  return (
    <p className="[&_a]:text-huddle-intro-primary-magenta absolute bottom-3 z-20 w-full text-center text-[11px] text-white lg:bottom-10 lg:left-20 lg:text-left lg:text-[13px] [&_a]:font-bold [&_a]:underline [&_a]:decoration-white/50 [&_a]:decoration-wavy">
      Challenge by{" "}
      <a
...
function SocialMedia() {
  return (
    <div className="[&_a:hover]:border-huddle-intro-primary-magenta mt-[64px] flex items-center justify-center gap-[10px] place-self-center lg:absolute lg:bottom-[40px] lg:right-[80px] lg:mt-0 lg:gap-[16px] lg:place-self-start [&_a]:flex [&_a]:aspect-square [&_a]:w-[28px] [&_a]:items-center [&_a]:justify-center [&_a]:rounded-full [&_a]:border lg:[&_a]:w-10">
      <a
        href=""
        className="group"
      >
