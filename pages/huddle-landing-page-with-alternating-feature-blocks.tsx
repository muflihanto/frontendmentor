  ...
  return (
    <>
      ...
      <div className="App font-open-sans relative">
        <Header />
        <Hero />
        <div className="flex flex-col gap-[40px] px-[20px] pt-[59px] pb-[53px] lg:px-[103px] lg:pt-[160px] lg:pb-[65px]">
          <Card
...
function Header() {
  return (
    <header className="absolute top-0 left-0 flex w-full items-center justify-between px-[16px] py-6 lg:py-[48px] lg:px-20">
...
function Card({ children, className, reverse }: { children: ReactElement | ReactElement[]; className?: string; reverse?: boolean }) {
  return <div className={"flex h-[488px] w-full flex-col items-center justify-center rounded-[16px] bg-white shadow-[0px_0px_15px_5px_rgba(0,0,0,.05)] lg:h-[440px] lg:justify-between " + (reverse ? "lg:flex-row-reverse lg:pr-[27px] lg:pl-[120px] " : "lg:flex-row lg:pr-[33px] lg:pl-[122px] ") + className}>{children}</div>;
}
