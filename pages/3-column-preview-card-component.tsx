...
function LearnMore({ href = "" }: { href?: string }) {
  return (
    <a
      href={href}
      className="relative mt-auto ml-[1px] inline-block h-[48px] w-[146px] overflow-hidden rounded-full bg-inherit focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
    >
      <span className="bg-3-column-neutral-200 absolute top-0 left-0 flex h-full w-full items-center justify-center pb-[1px] pr-[1px] text-center text-[15px] leading-none text-black mix-blend-screen">Learn More</span>
    </a>
  );
}
