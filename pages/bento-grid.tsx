...
function Main() {
  return (
    <div className="grid h-full w-full grid-cols-[repeat(1,minmax(0,400px))] place-content-center gap-8 bg-bento-purple-100/25 px-4 pb-[41px] pt-[32px] md:grid-cols-[repeat(2,minmax(0,400px))] md:py-16 lg:grid-cols-[repeat(4,minmax(0,256px))] lg:grid-rows-[324px,247px,247px] lg:pb-[64px] lg:pt-[83px]">
      <section className="flex h-[290px] w-full flex-col items-center justify-center rounded-lg bg-bento-purple-500 p-6 pt-[28px] md:col-span-2 lg:col-start-2 lg:h-full">
      ...
      <section className="flex min-h-[163px] w-full flex-col items-center justify-center rounded-lg bg-bento-white py-4 pl-4 pr-[10px] lg:col-start-2 lg:row-start-2 lg:overflow-hidden lg:p-6">
      ...
      <section className="flex h-[216px] w-full flex-col items-start overflow-hidden rounded-lg bg-bento-yellow-500 p-4 pb-0 lg:col-start-3 lg:row-start-2 lg:h-full lg:p-6">
      ...
      <section className="flex min-h-[469px] w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-bento-purple-100 p-[18.25px] py-8 lg:row-span-2 lg:items-start lg:p-8">
      ...
      <section className="flex h-[372px] w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-bento-purple-500 p-4 py-[23px] md:col-span-2 md:flex-row lg:col-start-3 lg:row-start-3 lg:h-auto lg:justify-between lg:gap-3 lg:px-6">
      ...
      <section className="flex h-[215px] w-full flex-col items-start overflow-hidden rounded-lg bg-bento-white p-6 pt-[22px] md:h-full lg:col-start-2 lg:row-start-3 lg:pt-[21px]">
      ...
      <div className="grid w-full grid-cols-1 gap-8 md:col-span-2 md:contents md:grid-cols-2 lg:col-span-1 lg:col-start-1 lg:row-span-3 lg:row-start-1 lg:grid lg:grid-cols-1">
        <section className="flex h-[234px] w-full flex-col items-start overflow-hidden rounded-lg bg-bento-yellow-100 p-8 pr-[30px] lg:col-start-1 lg:row-start-1 lg:h-[415px] lg:justify-center lg:pr-[28px]">
        ...
        <section className="flex h-[351px] w-full flex-col items-start overflow-hidden rounded-lg bg-bento-yellow-500 p-6 md:col-start-2 md:row-start-3 md:h-full lg:col-start-1 lg:row-start-2 lg:h-[434px]">
