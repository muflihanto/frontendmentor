...
const Hero = () => {
  return (
    <div className="flex h-[446px] flex-col items-center justify-center px-6 lg:h-[564px] lg:justify-start lg:pt-[170px]">
      <h1 className="font-poppins text-center text-[24px] font-bold leading-[36px] lg:text-[48px]">Build The Community Your Fans Will Love</h1>
      <p className="text-huddle-curve-neutral-700 font-open-sans mt-[22px] px-2 text-center text-[14px] lg:mt-[40px] lg:w-[640px] lg:text-[20px]">Huddle re-imagines the way we build communities. You have a voice, but so does your audience. Create connections with your users as you engage in genuine discussion. </p>
      <a
        href=""
        className="text-huddle-curve-neutral-100 hover:bg-huddle-curve-primary-pink-100 bg-huddle-curve-primary-pink-200 mt-[48px] flex h-10 w-[200px] items-center justify-center rounded-full text-[12px] font-bold shadow-[0px_5px_10px_rgba(0,0,0,.2)] lg:h-[80px] lg:w-[400px] lg:text-[20px]"
      >
  ...
  return (
    <div className="[&_>_div_>_p:nth-child(3)]:text-huddle-curve-neutral-700/50 max-md:[&_>_div_>_p:nth-child(3)]:font-poppins relative flex flex-col items-center gap-[94px] pt-[112px] pb-[4px] lg:flex-row lg:items-start lg:justify-start lg:gap-[440px] lg:pb-[20px] lg:pt-[108px] lg:pl-[280px] [&_>_div_>_p:nth-child(3)]:place-self-center [&_>_div_>_p:nth-child(3)]:text-center">
      <div className="grid w-[154px] grid-rows-[repeat(3,minmax(0,auto))] lg:place-items-start">
        ...
        <p className="text-[60px] font-bold leading-[82px] lg:mt-[14px] lg:text-[97px] lg:leading-none">1.4k+</p>
        <p className="mt-[6px] text-[14px] leading-[23px] lg:mt-[34px] lg:text-[24px]">Communities Formed</p>
      </div>
      <div className="grid w-[154px] grid-rows-[repeat(3,minmax(0,auto))] lg:place-items-start">
        ...
        <p className="text-[53px] font-bold leading-[74px] lg:mt-[18px] lg:text-[97px] lg:leading-none">2.7m+</p>
        <p className="mt-[4px] pr-[26px] max-md:w-[100px] max-md:text-[13px] lg:mt-[25px] lg:pr-[40px] lg:text-[24px]">Messages Sent</p>
      </div>
    </div>
  );
};
...
const GrowSection = () => {
  return (
    <div className="relative pt-[calc(100vw*112/375)] pb-[calc(100vw*52/375)] lg:mt-[116px] lg:pt-[calc(100vw*124/1080)] lg:pb-[calc(100vw*104/1080)]">
      ...
      <section className="bg-huddle-curve-neutral-100 flex h-[550px] flex-col items-center justify-start px-[27px] pt-[82px] lg:grid lg:h-[535px] lg:grid-cols-2 lg:grid-rows-1 lg:place-items-center lg:gap-x-[60px] lg:px-[130px] lg:pt-[24px]">
        <GrowIllustration className="w-[258px] lg:col-start-2 lg:w-[517px]" />
        <div className="lg:col-start-1 lg:row-start-1">
          <h2 className="text-huddle-curve-neutral-700 font-poppins mt-[76px] text-center text-[20px] font-bold lg:mt-0 lg:text-left lg:text-[40px]">Grow Together</h2>
          <p className="font-open-sans text-huddle-curve-neutral-700 mt-[15px] text-center text-[14px] lg:mt-[22px] lg:pr-[50px] lg:text-left lg:text-[16px]">Generate meaningful discussions with your audience and build a strong, loyal community. Think of the insightful conversations you miss out on with a feedback form.</p>
        </div>
      </section>
    ...
    <div className="relative pt-[calc(100vw*103/375)] pb-[calc(100vw*101/375)] lg:pt-[calc(100vw*156/1440)] lg:pb-[calc(100vw*139/1440)]">
      ...
      <section className="bg-huddle-curve-neutral-100 flex h-[542px] flex-col items-center justify-center px-[27px] pb-[100px] lg:grid lg:h-fit lg:grid-cols-2 lg:grid-rows-1 lg:place-items-center lg:gap-x-[80px] lg:px-[120px] lg:pt-[44px] lg:pb-[40px]">
        ...
        <div className="lg:col-start-1 lg:row-start-1">
          ...
          <p className="font-open-sans text-huddle-curve-neutral-700 mt-[13px] text-center text-[14px] lg:mt-[22px] lg:pr-[30px] lg:text-left lg:text-[16px]">It takes no time at all to integrate Huddle with your app&lsquo;s authentication solution. This means, once signed in to your app, your users can start chatting immediately.</p>
        </div>
      </section>
...
const CtaSection = () => {
  return (
    <section className="flex h-[467px] flex-col items-center justify-start px-[24px] pt-[67px] lg:mb-[50px] lg:pt-[160px]">
      <h2 className="font-poppins text-huddle-curve-neutral-700 text-center text-[24px] font-bold lg:ml-4 lg:text-[40px] lg:leading-[62px] lg:tracking-[-0.15px]">Ready To Build Your Community?</h2>
      <a
        href=""
        className="bg-huddle-curve-primary-pink-200 hover:bg-huddle-curve-primary-pink-100 mt-[37.5px] flex h-[40px] w-[200px] items-center justify-center rounded-full shadow-[0px_5px_5px_rgba(0,0,0,.12)] lg:h-[80px] lg:w-[400px]"
      >
        <span className="text-huddle-curve-neutral-100/90 pt-[2px] text-[12px] font-bold lg:text-[20px]">Get Started For Free</span>
      </a>
    </section>
  );
};
