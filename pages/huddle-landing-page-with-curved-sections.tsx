...
const ScreenMockups = ({ className }: { className: string }) => {
  return (
    <svg
      className={className}
...
const GrowSection = () => {
  return (
    <div className="relative pt-[112px] pb-[52px]">
      <div className="absolute top-0 left-0 aspect-[375/112] w-full -z-10">
        <Image
          className="object-contain"
          fill
          src="/huddle-landing-page-with-curved-sections/images/bg-section-top-mobile-1.svg"
          alt="Section Curved Background"
        />
      </div>
      <section className="bg-huddle-curve-neutral-100 h-[550px] flex flex-col justify-start items-center pt-[80px] px-[27px]">
        <svg
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
          xmlnsXlink="http://www.w3.org/1999/xlink"
        ...
        <h2 className="text-center font-bold text-[20px] text-huddle-curve-neutral-700 mt-[77px] font-poppins">Grow Together</h2>
        <p className="text-[14px] font-open-sans text-huddle-curve-neutral-700 text-center mt-[15px]">Generate meaningful discussions with your audience and build a strong, loyal community. Think of the insightful conversations you miss out on with a feedback form.</p>
      </section>
      <div className="absolute bottom-0 left-0 aspect-[375/52] w-full">
        <Image
          className="object-contain"
          fill
          src="/huddle-landing-page-with-curved-sections/images/bg-section-bottom-mobile-1.svg"
          alt="Section Curved Background"
        />
      </div>
    </div>
...
const FlowSection = () => {
  return (
    <section className="h-[644px] flex flex-col justify-center items-center px-[28px] pt-[20px]">
      <svg
        data-name="Layer 1"
        xmlns="http://www.w3.org/2000/svg"
        xmlnsXlink="http://www.w3.org/1999/xlink"
      ...
      <h2 className="text-center font-bold text-[20px] text-huddle-curve-neutral-700 mt-[88.5px] font-poppins">Flowing Conversations</h2>
      <p className="text-[14px] font-open-sans text-huddle-curve-neutral-700 text-center mt-[14px]">You wouldn&lsquo;t paginate a conversation in real life, so why do it online? Our threads have just-in-time loading for a more natural flow.</p>
    </section>
  );
};
...
const UsersSection = () => {
  return (
    <div className="relative pt-[103px] pb-[101px]">
      <div className="absolute top-0 left-0 aspect-[375/103] w-full -z-10">
        <Image
          className="object-contain"
          fill
          src="/huddle-landing-page-with-curved-sections/images/bg-section-top-mobile-2.svg"
          alt="Section Curved Background"
        />
      </div>
      <section className="bg-huddle-curve-neutral-100 h-[542px] flex flex-col justify-center items-center pb-[100px] px-[27px]">
        <svg
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
          xmlnsXlink="http://www.w3.org/1999/xlink"
        ...
        <h2 className="text-center font-bold text-[20px] text-huddle-curve-neutral-700 mt-[81px] font-poppins">Your Users</h2>
        <p className="text-[14px] font-open-sans text-huddle-curve-neutral-700 text-center mt-[13px]">It takes no time at all to integrate Huddle with your app&lsquo;s authentication solution. This means, once signed in to your app, your users can start chatting immediately.</p>
      </section>
      <div className="absolute bottom-0 left-0 aspect-[375/101] w-full">
        <Image
          className="object-contain"
          fill
          src="/huddle-landing-page-with-curved-sections/images/bg-section-bottom-mobile-2.svg"
          alt="Section Curved Background"
        />
      </div>
    </div>
...
const CtaSection = () => {
  return (
    <section className="h-[467px] flex flex-col items-center justify-start pt-[65px] px-[24px]">
      <h2 className="font-poppins font-bold text-[24px] text-center text-huddle-curve-neutral-700">Ready To Build Your Community?</h2>
      <a
        href=""
        className="h-[40px] mt-[37.5px] bg-huddle-curve-primary-pink-200 hover:bg-huddle-curve-primary-pink-100 rounded-full w-[200px] flex items-center justify-center shadow-[0px_5px_5px_rgba(0,0,0,.12)]"
      >
        <span className="font-bold font-poppins text-[12px] text-huddle-curve-neutral-100/75 pt-[2px]">Get Started For Free</span>
      </a>
    </section>
  );
};
