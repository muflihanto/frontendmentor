...
const Hero = () => {
  return (
    <div className="h-[446px] flex flex-col justify-center items-center px-6">
      <h1 className="text-center font-poppins text-[24px] leading-[36px]">Build The Community Your Fans Will Love</h1>
      ...
      <a
        href=""
        className="w-[200px] font-bold text-huddle-curve-neutral-100  bg-huddle-curve-primary-pink-200 shadow-[0px_5px_10px_rgba(0,0,0,.2)] text-[12px] flex items-center h-10 rounded-full justify-center mt-[48px]"
      >
        Get Started For Free
      </a>
    </div>
...
const Statistics = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center py-[112px] [&_>_div]:w-[154px] [&_>_div_>_p:nth-child(3)]:place-self-center [&_>_div_>_p:nth-child(3)]:text-center [&_>_div_>_p:nth-child(3)]:text-[15px] [&_>_div_>_p:nth-child(3)]:text-huddle-curve-neutral-700/50 [&_>_div_>_p:nth-child(3)]:mt-[6px] gap-[94px]">
      <div className="grid grid-rows-[repeat(3,minmax(0,auto))]">
