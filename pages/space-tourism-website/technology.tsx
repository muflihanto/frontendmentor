...
export default function Tech() {
  ...
  return (
    <>
      ...
      <main aria-label="Technology page" className="contents">
        <div
        ...
        >
          ...
          <div className="mt-[26px] flex w-[327px] flex-col items-center md:mt-11 md:w-[458px] lg:col-start-2 lg:row-start-2 lg:mt-[111px] lg:w-full lg:items-start">
            <h2 className="text-[14px] leading-[17px] tracking-[2.36px] text-space-tourism-lightblue md:text-base md:leading-[19px] md:tracking-[2.7px]">
              THE TERMINOLOGY…
            </h2>
