...
export default function Index() {
  return (
    <>
      ...
      <div className="App bg-space-tourism-black relative min-h-[100svh] bg-[url('/space-tourism-website/assets/home/background-home-mobile.jpg')] bg-cover p-6 pt-28 text-white md:min-h-[1024px] md:bg-[url('/space-tourism-website/assets/home/background-home-tablet.jpg')] md:pt-[202px] lg:flex lg:min-h-screen lg:flex-col lg:justify-end lg:bg-[url('/space-tourism-website/assets/home/background-home-desktop.jpg')] lg:px-0 lg:pb-[min(max(calc(100vh-769px),60px),131px)] lg:pt-[176px]">
        <Main />
        {/* <Slider
          basePath=""
  ...
  return (
    <div className="font-barlow flex flex-col items-center lg:flex-row lg:items-end lg:justify-between lg:px-[min(12vw,165px)]">
      <div className="flex flex-col items-center space-y-4 md:space-y-6 lg:items-start lg:space-y-6 lg:[&>*]:text-left">
        ...
        <p className="text-space-tourism-lightblue text-center text-[15px] leading-[25px] md:w-[444px] md:translate-y-[-1px] md:text-base md:leading-[28px] lg:w-[450px] lg:text-[18px] lg:leading-[32px]">
      ...
      <Link
        ...
        className="bg-space-tourism-white hover:ring-space-tourism-lightblue/10 mt-[81px] flex aspect-square w-[150px] items-center justify-center rounded-full hover:ring-[50px] md:mt-[156px] md:w-[242px] md:hover:ring-[75px] lg:mt-0 lg:w-[274px] lg:hover:ring-[88px]"
      >
