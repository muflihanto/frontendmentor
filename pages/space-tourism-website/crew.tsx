  ...
  return (
    <>
      ...
      <div className="text-space-tourism-white flex min-h-[710px] flex-col items-center bg-[url('/space-tourism-website/assets/crew/background-crew-mobile.jpg')] bg-[length:100vw_auto] px-6 pb-[58px] pt-[88px] bg-blend-screen md:grid md:min-h-[1024px] md:grid-cols-1 md:grid-rows-[repeat(4,auto)] md:place-content-start md:bg-[url('/space-tourism-website/assets/crew/background-crew-tablet.jpg')] md:px-[38.5px] md:pb-0 md:pt-[136px] lg:relative lg:min-h-[900px] lg:w-full lg:grid-cols-[auto] lg:grid-rows-[34px,auto,15px] lg:content-stretch lg:bg-[url('/space-tourism-website/assets/crew/background-crew-desktop.jpg')] lg:bg-cover lg:pb-[94px] lg:pl-[165px] lg:pr-0 lg:pt-[212px]">
        <h5 className="text-space-tourism-white uppercase leading-[19px] tracking-[2.7px] md:self-start md:text-[20px] md:leading-6 md:tracking-[3.38px] lg:self-end lg:text-[28px] lg:leading-[34px] lg:tracking-[4.72px]">
          <span className="mr-[14px] font-bold opacity-25 lg:mr-5">02</span>Meet your crew
        </h5>
        ...
        <div
          className={cn([
            ...
            crewIndex === 0 ? "md:mt-0 md:h-[572px] md:overflow-hidden" : "md:mt-10 md:h-[532px]", // medium crew-specific size
            crewIndex === 0 ? "lg:bottom-[-94px] lg:right-[142px] lg:aspect-[514/700] lg:h-[700px]" : crewIndex === 1 ? "lg:bottom-[-94px] lg:right-[192px] lg:aspect-[433/640] lg:h-[640px]" : crewIndex === 2 ? "lg:bottom-[-94px] lg:right-[142px] lg:aspect-[549/645] lg:h-[645px]" : "lg:bottom-[-94px] lg:right-[118px] lg:aspect-[575/602] lg:h-[602px]", // large crew-specific size
          ])}
        >
          <Image
            fill
        ...
        >
          <h4 className="font-bellefair uppercase leading-[18px] text-white/50 md:text-[24px] md:leading-[28px] lg:text-[32px] lg:leading-[37px]">{crew.role}</h4>
          <h3 className="font-bellefair mt-2 text-2xl uppercase leading-[28px] text-white md:text-[40px] md:leading-[45px] lg:mt-[15px] lg:text-[56px] lg:leading-[64px]">{crew.name}</h3>
          <p className="font-barlow text-space-tourism-lightblue mt-4 text-center text-[15px] leading-[25px] md:text-base md:leading-[28px] lg:mt-[27px] lg:w-[444px] lg:text-left lg:text-[18px] lg:leading-[32px]">{crew.bio}</p>
        </div>
      </div>
