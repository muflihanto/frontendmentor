    ...
    >
      <div className="flex flex-col gap-8 lg:gap-12">
        <section>
          ...
          <div
            className={cn(
              "relative h-[286px] overflow-hidden rounded-[20px]",
              showSkeleton
                ? "flex items-center justify-center bg-weather-app-neutral-800 p-8"
                : "bg-[image:url('/weather-app/assets/images/bg-today-small.svg')] bg-cover bg-center p-8 pt-[38px] lg:flex lg:items-center lg:justify-between lg:bg-[image:url('/weather-app/assets/images/bg-today-large.svg')] lg:px-6 lg:py-0",
            )}
          >
            {showSkeleton ? (
