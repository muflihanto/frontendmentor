...
export default function Header(props) {
  return (
    <>
      <header className="bg-[url('/sunnyside-agency-landing-page/images/mobile/image-header.jpg')] lg:bg-[url('/sunnyside-agency-landing-page/images/desktop/image-header.jpg')] bg-cover relative flex flex-col justify-center items-center w-full aspect-[375/538] gap-[49px] pt-[11px] bg-sunny-primary-yellow lg:aspect-auto lg:w-screen lg:h-screen lg:bg-contain lg:bg-bottom lg:pt-0 lg:gap-[104px] lg:pb-[123px] lg:font-black">
        <nav className="absolute z-10 top-0 w-full bg-transparent flex justify-between items-center px-6 h-[5.5rem] group lg:px-10 lg:h-[7.8rem]">
          <div className="relative w-[124px] h-auto aspect-[31/6] lg:w-[170px]">
            <Image
          ...
          >
            <li className="text-[20px] -tracking-[0.1px] font-barlow text-sunny-neutral-300 lg:text-sunny-neutral-100 lg:font-medium lg:text-[18px] lg:h-[25px] hover:text-sunny-primary-blue">
              <a href="">About</a>
            </li>
            <li className="text-[20px] -tracking-[0.1px] font-barlow text-sunny-neutral-300 lg:text-sunny-neutral-100 lg:font-medium lg:text-[18px] lg:h-[25px] hover:text-sunny-primary-blue">
              <a href="">Services</a>
            ...
            <li className="text-[15px] font-fraunces text-sunny-neutral-500 mt-[2px] mr-[4px] bg-sunny-primary-yellow py-[17px] px-8 text-center rounded-full uppercase font-bold hover:cursor-pointer lg:bg-sunny-neutral-100 lg:hover:bg-sunny-neutral-100/50 lg:hover:text-sunny-neutral-100 lg:-ml-[2px] lg:mt-0 lg:font-extrabold lg:-tracking-[0.2px]">
              <a href="">Contact</a>
            </li>
          </ul>
        </nav>
        <h1
          className="font-fraunces font-black text-sunny-neutral-100 text-[40px] tracking-[7px] text-center leading-[49px] uppercase
