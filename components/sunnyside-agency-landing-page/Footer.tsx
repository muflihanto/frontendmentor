export default function Footer() {
  return (
    <footer className="bg-[#90d4c5] relative flex flex-col justify-center items-center pt-[69px] pb-[80px] lg:pt-[77px] lg:pb-[71px]">
      ...
      <div className="flex gap-7 mt-[87px] items-center -translate-x-[2px]">
        <a href="">
          <svg
            className="group"
            width="20"
          ...
          >
            <path
              ...
              className="group-hover:fill-sunny-neutral-100"
              fill="#2C7566"
              fillRule="nonzero"
            />
          </svg>
      ...
      <div className="text-[11px] font-barlow text-sunny-primary-cyan-100 absolute bottom-3 text-center w-full">
        Challenge by{" "}
        <a
          href="https://www.frontendmentor.io?ref=challenge"
          target="_blank"
          rel="noreferrer"
          className="text-[#2C7566] hover:text-sunny-neutral-100 font-fraunces hover:drop-shadow-sm font-black"
        >
          Frontend Mentor
        </a>
        . Coded by{" "}
