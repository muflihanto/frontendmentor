export default function Transform() {
  return (
    ...
    >
      ...
      <div
        className="bg-sunny-primary-red/[0.03] px-4 py-16 text-center lg:flex lg:flex-col lg:justify-center lg:py-0 lg:pl-[165px] lg:pr-[105px]"
        role="none"
      >
        <h2
          className="font-fraunces text-[32px] font-black leading-[39px] text-sunny-neutral-500 lg:text-left lg:text-[40px] lg:leading-[50px] lg:tracking-[0.15px]"
