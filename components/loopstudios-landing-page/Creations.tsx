        ...
        {creations.map((el, index) => {
          return (
            ...
            >
              <a
                href=""
                className="flex h-full w-3/4 items-end bg-gradient-to-r from-black/[.6] to-transparent pb-[22px] pl-[21px] pr-[100px] font-josefin text-[24px] uppercase leading-none tracking-[.8px] text-loopstudios-primary-white/75 transition-colors group-[&:nth-child(4)]:pr-[120px] lg:h-[70%] lg:w-full lg:bg-gradient-to-t lg:px-10 lg:pb-[35px] lg:text-[32px] lg:leading-[32px] lg:hover:h-full lg:hover:from-white/75 lg:hover:to-white/75 lg:hover:text-loopstudios-primary-black"
              >
                {el.title}
              </a>
            </li>
