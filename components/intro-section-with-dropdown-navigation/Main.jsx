...
export default function Main(props) {
  return (
    <main className="mt-[41px] px-4 lg:px-0 lg:flex lg:justify-between lg:flex-col">
      <div className="lg:flex lg:flex-col lg:items-start lg:justify-center lg:h-full lg:gap-[47px]">
        <h1
          className="font-bold -tracking-[0.4px] text-center text-introdrop-neutral-300 text-[36px]
      lg:text-left lg:text-[80px] lg:leading-[82px] lg:-tracking-[1px] lg:pr-4"
        >
          Make remote work
        </h1>
        <p
      ...
      lg:text-left lg:text-[18px] lg:leading-[28px] lg:max-w-[480px] lg:m-0"
        ...
        <button className="block pl-[24px] pr-[22px] text-center rounded-[14px] mx-auto leading-[48px] font-medium bg-introdrop-neutral-300 text-introdrop-neutral-100 mt-[25px] lg:leading-[56.75px] lg:pl-8 lg:pr-7 lg:text-[18px] lg:m-0 lg:mt-[4px] lg:hover:bg-transparent lg:hover:border-introdrop-neutral-300 lg:shadow-[inset_0px_0px_0px_1.5px_hsla(0,0%,8%,.75)]  lg:hover:text-introdrop-neutral-300">
