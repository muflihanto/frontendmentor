  ...
  return (
    ...
    >
      <summary
        ...
        className="relative flex items-center justify-start gap-[15px] lg:gap-[7px] list-none hover:cursor-pointer w-fit"
      >
      ...
      <ul
        ...
        className={`pb-[8px] flex flex-col gap-[18px] lg:absolute lg:bottom-auto lg:top-[38px] lg:left-auto lg:bg-white lg:px-6 lg:py-5 lg:rounded-lg lg:text lg:shadow-[0px_0px_15px_10px_rgba(0,0,0,.05)] lg:gap-2 lg:before:w-full lg:before:content-[''] lg:before:h-[30px] lg:before:right-0 lg:before:top-[-30px] lg:before:bg-transparent lg:before:absolute lg:w-max ${props.addClass}`}
      >
        {props.items}
      </ul>
    </details>
