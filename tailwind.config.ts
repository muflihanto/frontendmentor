  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "plus-jakarta-italic": [
          "var(--font-plus-jakarta-italic)",
          "Plus Jakarta Sans Italic",
          ...fontFamily.sans,
        ],
        "dm-sans": ["var(--font-dm-sans)", "DM Sans", ...fontFamily.sans],
        epilogue: ["var(--font-epilogue)", "Epilogue", ...fontFamily.sans],
        manrope: ["var(--font-manrope)", "Manrope", ...fontFamily.sans],
        rubik: ["var(--font-rubik)", "Rubik", ...fontFamily.sans],
        "space-mono": [
          "var(--font-space-mono)",
          "Space Mono",
          ...fontFamily.mono,
        ],
        barlow: ["var(--font-barlow)", "Barlow", ...fontFamily.sans],
        fraunces: ["var(--font-fraunces)", "Fraunces", ...fontFamily.serif],
        ubuntu: ["var(--font-ubuntu)", "Fraunces", ...fontFamily.sans],
        overpass: ["var(--font-overpass)", "Overpass", ...fontFamily.sans],
        ...
        josefin: ["var(--font-josefin)", "Josefin Sans", ...fontFamily.sans],
        alata: ["var(--font-alata)", "Alata", ...fontFamily.sans],
        "open-sans": ["var(--font-open-sans)", "Open Sans", ...fontFamily.sans],
        poppins: ["var(--font-poppins)", "Poppins", ...fontFamily.sans],
        inter: ["var(--font-inter)", "Inter", ...fontFamily.sans],
        karla: ["var(--font-karla)", "Karla", ...fontFamily.sans],
        "dm-serif-display": [
        ...
        outfit: ["var(--font-outfit)", "Outfit", ...fontFamily.sans],
        "red-hat-display": [
        ...
        raleway: ["var(--font-raleway)", "Raleway", ...fontFamily.sans],
        "bai-jamjuree": [
        ...
        public: ["var(--font-public)", "Public Sans", ...fontFamily.sans],
        "be-vietnam": [
          "var(--font-be-vietnam)",
          "Be Vietnam",
          ...fontFamily.sans,
        ...
        bellefair: ["var(--font-bellefair)", "Bellefair", ...fontFamily.serif],
        "nunito-sans": [
